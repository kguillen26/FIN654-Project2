...
for (type in types) {
  ...
  print(ggplot(meltdf, 
          ...
          theme(plot.title = 
                  element_text(hjust = 0.5, size = 50),
...
In looking at the nature of the exchange rates we can see that the Chinese Yuan is the least volatile making it more predictable than the Yen, Euro and Pound, all of which experience high volatility.  The CNY also has the highest level of skewness and kurtosis which is very dangerous in the risk business.  Although the CNY may be the most predictable rate it associated with high risk.